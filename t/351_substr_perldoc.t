...
my $color  = Char::USASCII::substr $s, 4, 5;   # black
my $middle = Char::USASCII::substr $s, 4, -11; # black cat climbed the
my $end    = Char::USASCII::substr $s, 14;     # climebed the green tree
my $tail   = Char::USASCII::substr $s, -4;     # tree
my $z      = Char::USASCII::substr $s, -4, 2;  # tr
