...
# avoid: Name "Char::Eusascii::foo" used only once: possible typo at here.
${Char::Eusascii::dot}         = ${Char::Eusascii::dot};
${Char::Eusascii::dot_s}       = ${Char::Eusascii::dot_s};
${Char::Eusascii::eD}          = ${Char::Eusascii::eD};
${Char::Eusascii::eS}          = ${Char::Eusascii::eS};
${Char::Eusascii::eW}          = ${Char::Eusascii::eW};
${Char::Eusascii::eH}          = ${Char::Eusascii::eH};
${Char::Eusascii::eV}          = ${Char::Eusascii::eV};
${Char::Eusascii::eR}          = ${Char::Eusascii::eR};
${Char::Eusascii::eN}          = ${Char::Eusascii::eN};
${Char::Eusascii::not_alnum}   = ${Char::Eusascii::not_alnum};
${Char::Eusascii::not_alpha}   = ${Char::Eusascii::not_alpha};
${Char::Eusascii::not_ascii}   = ${Char::Eusascii::not_ascii};
${Char::Eusascii::not_blank}   = ${Char::Eusascii::not_blank};
${Char::Eusascii::not_cntrl}   = ${Char::Eusascii::not_cntrl};
${Char::Eusascii::not_digit}   = ${Char::Eusascii::not_digit};
${Char::Eusascii::not_graph}   = ${Char::Eusascii::not_graph};
${Char::Eusascii::not_lower}   = ${Char::Eusascii::not_lower};
${Char::Eusascii::not_lower_i} = ${Char::Eusascii::not_lower_i};
${Char::Eusascii::not_print}   = ${Char::Eusascii::not_print};
${Char::Eusascii::not_punct}   = ${Char::Eusascii::not_punct};
${Char::Eusascii::not_space}   = ${Char::Eusascii::not_space};
${Char::Eusascii::not_upper}   = ${Char::Eusascii::not_upper};
${Char::Eusascii::not_upper_i} = ${Char::Eusascii::not_upper_i};
${Char::Eusascii::not_word}    = ${Char::Eusascii::not_word};
${Char::Eusascii::not_xdigit}  = ${Char::Eusascii::not_xdigit};
${Char::Eusascii::eb}          = ${Char::Eusascii::eb};
${Char::Eusascii::eB}          = ${Char::Eusascii::eB};
...
sub Char::USASCII::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::USASCII::escape_token();
    }
...
# subroutines of package Char::Eusascii
    ...
    elsif (/\G \b Char::USASCII::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::USASCII::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::USASCII::escape'; }
...
# subroutines of package Char::Eusascii
        ...
        elsif ($string =~ /\G \b Char::USASCII::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::USASCII::eval \b                                /oxgc) { $e_string .= 'eval Char::USASCII::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::USASCII::re_t=%s; while($Char::USASCII::re_t =~ %s){%s local $^W=0; local $Char::USASCII::re_r=%s; %s$Char::USASCII::re_t="$`$Char::USASCII::re_r$'"; pos($Char::USASCII::re_t)=length "$`$Char::USASCII::re_r"; } return $Char::USASCII::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::USASCII::re_r=CORE::eval $Char::USASCII::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::USASCII::re_r=%s; %s"%s$Char::USASCII::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::USASCII::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::USASCII::re_r=%s; %s%s="$`$Char::USASCII::re_r$'"; pos(%s)=length "$`$Char::USASCII::re_r"; $Char::USASCII::re_n++} return %s$Char::USASCII::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::USASCII::re_r=%s; %s%s="%s$Char::USASCII::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::USASCII::re_r=%s; %s%s="%s$Char::USASCII::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::USASCII::re_r=CORE::eval $Char::USASCII::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
This module has run-time routines for use Char::USASCII software automatically, you
do not have to use.
