...
######################################################################
#
# Char::USASCII - Source code filter to US-ASCII script
#
...
sub Char::USASCII::escape_script {
    ...
    if (/^ use Char::Eusascii(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Eusascii %s;\n%s", $Char::Eusascii::VERSION, $use_re_eval); # require run-time routines version
...
Char::USASCII - Source code filter to escape US-ASCII

=head1 SYNOPSIS

  use Char::USASCII;
  use Char::USASCII version;         --- require version
