...
$VERSION = sprintf '%d.%02d', q$Revision: 0.98 $ =~ /(\d+)/oxmsg;
...
# subroutines of package Char::Eusascii
...
import of Char/Eusascii.pm works well.
...
=head1 Un-Escaping bytes::* Subroutines (Char/USASCII.pm provides)

Char/USASCII.pm removes 'bytes::' at head of subroutine name.
...
exist at time of be written this document and JPerl did exist.
                        ...
                        (a)     (b)     (c)     (d)     (e)
                                      JPerl,japerl    Encode,Char::USASCII
      +--------------+-------+-------+-------+-------+-------+
      | data         |  Old  |  Old  |  New  |  Old  |  New  |
      +--------------+-------+-------+-------+-------+-------+
      | script       |  Old  |      Old      |      New      |
