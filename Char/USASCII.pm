...
10% everything else. But this "text" means US-ASCII text, and popular US-ASCII
...
Perl3 or later can treat US-ASCII.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::USASCII software is Perl program designed to make the "easy jobs easy".
...
Contrasting is Encode module and describing "use Char::USASCII;" on this software,
