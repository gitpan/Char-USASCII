...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Eusascii::function_ord     = 'Char::USASCII::ord'     if /\A ord \z/oxms;
                    $Char::Eusascii::function_ord_    = 'Char::USASCII::ord_'    if /\A ord \z/oxms;
                    $Char::Eusascii::function_reverse = 'Char::USASCII::reverse' if /\A reverse \z/oxms;
                    $Char::Eusascii::function_getc    = 'Char::USASCII::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::USASCII::escape();
...
=head1 Calling 'Char::Eusascii::ignorecase()' (Char::USASCII software provides)

Char::USASCII software applies calling 'Char::Eusascii::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::USASCII software provides)

Char::USASCII software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::USASCII software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::USASCII software provides)

Char::USASCII software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::USASCII software and
