...
$VERSION = sprintf '%d.%02d', q$Revision: 0.77 $ =~ m/(\d+)/oxmsg;
...
# split
            ...
            my $e_string = 'Char::Eusascii::split';
...
=item * Possible to handle raw US-ASCII values

=item * Backward compatibility of data, script and how to

=item * Only Char/USASCII.pm and Char/Eusascii.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Char::Eusascii::lc
  lcfirst     Char::Eusascii::lcfirst
  uc          Char::Eusascii::uc
  ucfirst     Char::Eusascii::ucfirst
  chr         Char::Eusascii::chr
  glob        Char::Eusascii::glob
  ---------------------------------
...
Char/USASCII.pm remove 'bytes::' at head of function name.
...
Char/USASCII.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
page 402 of Programming Perl, 3rd ed. again.
  ...
  Information processing model beginning with this software
    ...
    +-----------------------------------+
    |      ASCII Compatible Encoding    | ex. US-ASCII
    +-----------------------------------+
                (No UTF8 Flag)
