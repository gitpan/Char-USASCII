...
#               $pattern .= "(?:$your_char)",   # UNIX style
        ...
        my $matchsub = sub { Eusascii::fc($_[0]) =~ m{\A $pattern \z}xms };
...
=item Chop string
  ...
  character chopped. The Eusascii::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Eusascii::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Eusascii::fc function for case-insensitive comparisons via USASCII
  software.
...
=item Fold case string
  ...
  New to USASCII software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Eusascii::glob function grandfathers the use of whitespace to separate multiple
